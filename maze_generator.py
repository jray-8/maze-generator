...
try:
    STAR_IMAGE = pygame.image.load("masks/star.png")
    CROWN_IMAGE = pygame.image.load("masks/crown.png")
    CROWN_2_IMAGE = pygame.image.load("masks/crown_2.png")
    L_ARROW = pygame.image.load("menu/left_arrow.png")
    R_ARROW = pygame.image.load("menu/right_arrow.png")
    SL_ARROW = pygame.image.load("menu/selected_left_arrow.png")
    SR_ARROW = pygame.image.load("menu/selected_right_arrow.png")
